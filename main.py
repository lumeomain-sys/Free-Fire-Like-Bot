...
REQUIRED_CHANNELS = ["@eryxfreelikechannel"]
GROUP_JOIN_LINK = "https://t.me/eryxfreelike"
OWNER_ID = 1003790120060
OWNER_USERNAME = "@@eryx_og"
...
def call_api(region, uid):
    url = f"8666040097:AAGOG4EEaGkwq1DdDL_JpvRwDbX3ciJSpjQuid={uid}&server_name={region}"
    try:
